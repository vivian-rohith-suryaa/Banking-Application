...
<div class="profile-sidebar-content">
	...
	<div class="profile-details">
		...
		<% if (role == 1) { %>
			...
			<div class="profile-row">
				<span>PAN:</span>
				<div id="profile-pan"></div>
			</div>
			<div class="profile-row">
				<span>Aadhaar:</span>
				<div id="profile-aadhar"></div>
			</div>
		<% } %>
	</div>
...
<div class="profile-sidebar-content">
	<div class="profile-header">
		...
		<span class="close-btn"
			onclick="document.getElementById('profile-sidebar').classList.remove('open')">&times;</span>
	</div>

	<div class="profile-center">
		<img src="<%=request.getContextPath()%>/icons/popup-profile.svg"
	...
	<%
	if (role <= 2) { // Show additional fields only for Customers and Employees
	%>
	<div class="profile-row">
		<span>DOB:</span>
		<div id="profile-dob"></div>
	...
	<div class="profile-actions">
		<img src="<%=request.getContextPath()%>/icons/edit.svg"
			alt="Edit Profile" class="action-icon" id="edit-profile-btn"> <img
			src="<%=request.getContextPath()%>/icons/logout.svg" alt="Logout"
			class="action-icon" id="logout-btn">
	</div>
