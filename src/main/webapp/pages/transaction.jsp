...
%>
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/styles/transaction.css">

<div class="employee-data-panel">
	<div class="section-header">
		<h2 id="section-title">Transactions</h2>
		<div class="filters">	
...
<script type="module">
    ...
    import(`${contextPath}/scripts/transaction.js`)
        .then(mod => mod.initTransactionModule(contextPath, userId, role, branchId));
</script>
