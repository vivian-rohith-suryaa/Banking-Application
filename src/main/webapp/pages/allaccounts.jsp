...
%>
<link rel="stylesheet" href="<%=request.getContextPath()%>/styles/allaccounts.css">

<div class="employee-data-panel">
    <div class="section-header">
        <h2 id="section-title">Accounts</h2>
        <div class="filters">
...
<script type="module">
    ...
    import(`${contextPath}/scripts/allaccounts.js`)
        .then(mod => mod.initAccountsModule(contextPath, userId, role, branchId));
</script>
